    ...
    return (
        <div>
            <div className="flex flex-row h-[100vh] bg-blue-purple pt-[10vh] pb-[5vh] font-sans">
                <div className="w-full md:w-[60%] mx-[10%] flex justify-center flex-col text-black">
                    ...
                    <div>
                        <button className="bg-white text-[18px] px-[40px] py-[7px] rounded-[5px]"> Get Started For Free </button>
                    </div>
                </div>
